...
PCS template to VISIO.vss can be used in Lucidchart by selecting the option "more figures" (left side of the main screen), selection the option "import figures", selecting the option "add a new library" and searching the downloaded file in the location. Then, the template should appear in the "figures".
